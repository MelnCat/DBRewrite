declare module "hjson" {
	...
	export interface HJSON {
		parse(text: string, options?: DeserializeOptions): /* change any to unknown */ unknown;
		stringify(value: /* change any to unknown */ unknown, options?: SerializeOptions): string;
	}
	const hjson: HJSON & { rt: HJSON };
